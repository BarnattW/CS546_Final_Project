...
import { intializeCollectionFn } from "./config/mongoCollections.js";
...
await intializeCollectionFn("customers");
await intializeCollectionFn("sellers");
await intializeCollectionFn("listings");
